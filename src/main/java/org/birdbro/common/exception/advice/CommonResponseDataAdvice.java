...
import org.birdbro.common.exception.global.GlobalProperties;
...
/**
 *  统一返回包装器 {@link IgnoreResponseAdvice}
 *  处理解析 {@link ResponseBodyAdvice}
 * @author bird
 * @date 2021-7-21 9:23
 **/
...
public class CommonResponseDataAdvice implements ResponseBodyAdvice<Object> {
    ...
    private GlobalProperties globalDefaultProperties;

    public CommonResponseDataAdvice(GlobalProperties globalDefaultProperties) {
